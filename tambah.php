...
<body oncontextmenu="return false;">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="bungkus">
        <h2 class="mt-4">Tambah Data Mahasiswa</h2>
        <form method="POST" action="proses_tambah.php" class="form1">

          <div class="form-group">
            <label for="exampleFormControlInput1">Nama Lengkap</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="nama" onpaste="restrict(this);"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" name="nomor_hp"
              onpaste="restrict4(this);" onkeypress="restrict4(this);" onkeyup="restrict4(this);">
          </div>
          <div class="form-group">
